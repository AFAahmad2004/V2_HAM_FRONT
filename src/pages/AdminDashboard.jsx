...
export default function AdminDashboard() {
  ...
  const fetchProducts = async () => {
    const res = await fetch("https://back-h-sr2i.onrender.com/products");
  ...
  const handleAddProduct = async () => {
    ...
    try {
      const res = await fetch("https://back-h-sr2i.onrender.com/add_product", {
        method: "POST",
        headers: headers(),
  ...
  const handleDeleteProduct = async (id) => {
    ...
    await fetch(`https://back-h-sr2i.onrender.com/delete_product/${id}`, { method: "DELETE", headers: headers() });
    fetchProducts();
  };

  // ========== UPDATES ==========
  const fetchUpdates = async () => {
    const res = await fetch("https://back-h-sr2i.onrender.com/updates");
    const data = await res.json();
    setUpdates(data);
  };
  ...
  const handleAddUpdate = async () => {
    ...
    const res = await fetch("https://back-h-sr2i.onrender.com/add_update", {
  ...
  const handleDeleteUpdate = async (id) => {
    ...
    await fetch(`https://back-h-sr2i.onrender.com/delete_update/${id}`, { method: "DELETE", headers: headers() });
    fetchUpdates();
  };
